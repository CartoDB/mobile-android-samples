...
public class PackageManagerBaseActivity extends ListActivity {
    ...
    protected CartoPackageManager packageManager;
    protected ArrayAdapter<Package> packageAdapter;
    protected ArrayList<Package> packageArray = new ArrayList<Package>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File packageFolder = new File(getApplicationContext().getExternalFilesDir(null), getFolderName());
        if (!(packageFolder.mkdirs() || packageFolder.isDirectory())) {
            Log.e(MapApplication.LOG_TAG, "Could not create package folder!");
        }
        try {
            packageManager = new CartoPackageManager(getSource(), packageFolder.getAbsolutePath());
        }
        catch (IOException e) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem menuItem = menu.add("Map").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener(){
            @Override
